...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 9e954a30-885f-4f8e-96f6-22065977c065
```

> `9e954a30-885f-4f8e-96f6-22065977c065` is the password of the certificate, you can change it to any password you want.
